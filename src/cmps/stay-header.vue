<template>
        ...
        <div class="header-center">
            <router-link to="/">
                <div class="logo" @click="setShowExplore">
                    <svg xmlns="http://www.w3.org/2000/svg" style="display: inline-block; height: 32px; width: 38px">
                        <path
            ...
            <router-link to="/login">
                <div @click="isLoginOpen = !isLoginOpen" class="btn-user-all">
                    <a class="btn-user">
                        ...
                        <div class="user-svg">
                            <svg v-if="!loggedinUser" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="screen main-container full" v-if="isOpen" @click="isOpen = false"></div>
</template>
