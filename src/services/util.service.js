...
function getImage(){
  let imgNum = utilService.getRandomIntInclusive(0,75)
  return utilService.getRandomIntInclusive(0, 1) > 0.5  ? `http://xsgames.co/randomusers/assets/avatars/male/${imgNum}.jpg` : `https://xsgames.co/randomusers/assets/avatars/female/${imgNum}.jpg` 
}
